    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    + "This is a friendly remainder to add your income and expenses for today in MoneyMate. <br><br>"
                    ...
                    + "<br><br>Best regards, <br> MoneyMate Team";
    ...
    public void sendDailyExpenseSummary() {
        ...
        for(ProfileEntity profile: profiles){
            ...
            if(!todaysExpenses.isEmpty()){
                ...
                table.append("</table>");
                String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>MoneyMate Team";
